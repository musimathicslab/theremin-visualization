...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_RenderScale = { "RenderScale", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLPlaneTransformPass, RenderScale), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_RenderScale_MetaData), Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_RenderScale_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_Plane = { "Plane", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLPlaneTransformPass, Plane), Z_Construct_UClass_AOWLVideoPlanePlacement_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_Plane_MetaData), Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_Plane_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_CameraOverride = { "CameraOverride", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLPlaneTransformPass, CameraOverride), Z_Construct_UClass_ACameraActor_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_CameraOverride_MetaData), Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_CameraOverride_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_FrameDelay = { "FrameDelay", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLPlaneTransformPass, FrameDelay), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_FrameDelay_MetaData), Z_Construct_UClass_UOWLPlaneTransformPass_Statics::NewProp_FrameDelay_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLPlaneTransformPass_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOWLPlaneTransformPass, UOWLPlaneTransformPass::StaticClass, TEXT("UOWLPlaneTransformPass"), &Z_Registration_Info_UClass_UOWLPlaneTransformPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWLPlaneTransformPass), 1262394145U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLPlaneTransformPass_h_2903890759(TEXT("/Script/OWLComposure"),
