...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UViewportSettings_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UViewportSettings_BindEvents, "BindEvents" }, // 1720356708
		{ &Z_Construct_UFunction_UViewportSettings_OnPostPIEStarted, "OnPostPIEStarted" }, // 2908854393
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UViewportSettings_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_Features_ViewportSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UViewportSettings, UViewportSettings::StaticClass, TEXT("UViewportSettings"), &Z_Registration_Info_UClass_UViewportSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UViewportSettings), 3380503399U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_Features_ViewportSettings_h_806521393(TEXT("/Script/LivestreamingToolkit"),
