...
template<> LIVESTREAMINGTOOLKIT_API UScriptStruct* StaticStruct<FDummyStruct>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_ServerAuth_MeteredUsageWorker_h_Statics::ScriptStructInfo[] = {
		{ FDummyStruct::StaticStruct, Z_Construct_UScriptStruct_FDummyStruct_Statics::NewStructOps, TEXT("DummyStruct"), &Z_Registration_Info_UScriptStruct_DummyStruct, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDummyStruct), 2483267917U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_ServerAuth_MeteredUsageWorker_h_2063853327(TEXT("/Script/LivestreamingToolkit"),
		nullptr, 0,
