...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UOWLNDIOutputPass_Statics::NewProp_SenderName = { "SenderName", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLNDIOutputPass, SenderName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLNDIOutputPass_Statics::NewProp_SenderName_MetaData), Z_Construct_UClass_UOWLNDIOutputPass_Statics::NewProp_SenderName_MetaData) };
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UOWLNDIOutputPass_Statics::NewProp_bCaptureAudio = { "bCaptureAudio", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UOWLNDIOutputPass), &Z_Construct_UClass_UOWLNDIOutputPass_Statics::NewProp_bCaptureAudio_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLNDIOutputPass_Statics::NewProp_bCaptureAudio_MetaData), Z_Construct_UClass_UOWLNDIOutputPass_Statics::NewProp_bCaptureAudio_MetaData) };
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLNDIOutputPass_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOWLNDIOutputPass, UOWLNDIOutputPass::StaticClass, TEXT("UOWLNDIOutputPass"), &Z_Registration_Info_UClass_UOWLNDIOutputPass, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWLNDIOutputPass), 253414745U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLComposure_Public_OWLNDIOutputPass_h_180851045(TEXT("/Script/OWLComposure"),
