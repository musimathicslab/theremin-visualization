...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOWLNDISoundWaveFactory_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "Factories/OWLNDISoundWaveFactory.h" },
		{ "ModuleRelativePath", "Public/Factories/OWLNDISoundWaveFactory.h" },
	};
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UOWLNDISoundWaveFactory_Statics::StaticCppClassTypeInfo = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkitEditor_Public_Factories_OWLNDISoundWaveFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOWLNDISoundWaveFactory, UOWLNDISoundWaveFactory::StaticClass, TEXT("UOWLNDISoundWaveFactory"), &Z_Registration_Info_UClass_UOWLNDISoundWaveFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWLNDISoundWaveFactory), 2723836969U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkitEditor_Public_Factories_OWLNDISoundWaveFactory_h_281547524(TEXT("/Script/LivestreamingToolkitEditor"),
