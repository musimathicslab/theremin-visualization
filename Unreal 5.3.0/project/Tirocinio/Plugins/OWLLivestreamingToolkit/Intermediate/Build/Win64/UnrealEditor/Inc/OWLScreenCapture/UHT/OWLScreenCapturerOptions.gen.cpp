...
template<> OWLSCREENCAPTURE_API UScriptStruct* StaticStruct<FOWLScreenCaptureOptions>()
{
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_Active = { "Active", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLScreenCaptureOptions), &Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_Active_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_Active_MetaData), Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_Active_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_CaptureCursor = { "CaptureCursor", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLScreenCaptureOptions), &Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_CaptureCursor_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_CaptureCursor_MetaData), Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_CaptureCursor_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_bHideRenderTarget = { "bHideRenderTarget", nullptr, (EPropertyFlags)0x0010000000022015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLScreenCaptureOptions), &Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_bHideRenderTarget_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_bHideRenderTarget_MetaData), Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewProp_bHideRenderTarget_MetaData) };
	...
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h_Statics::EnumInfo[] = {
		{ EOWLScreenCaptureType_StaticEnum, TEXT("EOWLScreenCaptureType"), &Z_Registration_Info_UEnum_EOWLScreenCaptureType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 526138634U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h_Statics::ScriptStructInfo[] = {
		{ FOWLScreenCaptureOptions::StaticStruct, Z_Construct_UScriptStruct_FOWLScreenCaptureOptions_Statics::NewStructOps, TEXT("OWLScreenCaptureOptions"), &Z_Registration_Info_UScriptStruct_OWLScreenCaptureOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLScreenCaptureOptions), 3896068591U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapturerOptions_h_3921950413(TEXT("/Script/OWLScreenCapture"),
		nullptr, 0,
